    ...
    <DetailPageWrapper>
      ...
      <main className="space-y-4 pb-12 pt-0">
        ...
        <p className="text-[11px] leading-snug text-zinc-500">
          STEP 칩을 <span className="font-semibold text-zinc-600">탭</span>하면 아래「현재 STEP」이 바뀌고, 제목·도구·메모를 수정할 수 있어요. PC에서는 칩을 드래그해 순서도 바꿀 수 있습니다.
        </p>
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          <WorkspaceRelatedLinksSection
            ...
            onRemoveLink={removeRelatedLink}
            onUpdateLink={updateRelatedLink}
          />
          <WorkspaceWorkflowCommonMemosSection
            mode="editable"
            memos={workflowMemos}
            ...
            onAddMemo={addWorkflowMemo}
            onRemoveMemo={removeWorkflowMemo}
            onUpdateMemo={updateWorkflowMemoText}
          />
        </div>
      </main>
