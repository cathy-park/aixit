...
export function WorkflowRunStatusChip({ status }: { status: WorkflowRunStatus }) {
  switch (status) {
    case "시작전":
      return (
        <span className="inline-flex items-center gap-1 rounded-full bg-slate-50 px-2.5 py-0.5 text-xs font-semibold text-slate-700 ring-1 ring-slate-200">
          <CircleOutlineIcon className="h-3.5 w-3.5 shrink-0 stroke-slate-400" />
          시작전
        </span>
      );
    case "준비중":
    ...
    case "진행중":
      return (
        <span className="inline-flex items-center gap-1 rounded-full bg-sky-50 px-2.5 py-0.5 text-xs font-semibold text-sky-800 ring-1 ring-sky-200">
    ...
    case "완료":
      return (
        <span className="inline-flex items-center gap-1 rounded-full bg-emerald-50 px-2.5 py-0.5 text-xs font-semibold text-emerald-800 ring-1 ring-emerald-200">
          <svg className="h-3.5 w-3.5 shrink-0 stroke-emerald-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" aria-hidden>
    ...
    default:
      return (
        <span className="inline-flex items-center gap-1 rounded-full bg-zinc-100 px-2.5 py-0.5 text-xs font-semibold text-zinc-800 ring-1 ring-zinc-200">
          {status}
        </span>
      );
  }
